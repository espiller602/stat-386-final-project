...
The Streamlit application is organized into three primary functional components:

-Data Loading and Preparation
The app loads a cleaned dataset of NFL playoff quarterback passing statistics from 2018–2024. If the cleaned file is not available, the app automatically rebuilds it from the raw Pro Football Reference downloads using the project’s data-wrangling package. League-average rows are removed, and the dataset is cached to ensure consistent and efficient use across sessions.
